...
class MovieDetailPaginSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Movie> {
        ...
        return try {
            ...
            val moviesResponse: retrofit2.Response<SimilarMoviesDetails> = api.hitGetCategorizedMovies(url = ApiEndpoint.BASE_URL + ApiEndpoint.Discover.path(), page =  page)
